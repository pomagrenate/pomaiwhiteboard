...
import { SavedWhiteboardsModal } from "./components/SavedWhiteboardsModal";
...
import {
  ...
  exportToExcalidrawPlus,
} from "./components/ExportToPomaiPlus";
...
import { PomaiPlusIframeExport as ExcalidrawPlusIframeExport } from "./PomaiPlusIframeExport";

import "./index.scss";

import { PomaiPlusPromoBanner as ExcalidrawPlusPromoBanner } from "./components/PomaiPlusPromoBanner";
    ...
    >
      ...
      >
        <AppMainMenu
          ...
          onOpenSavedWhiteboards={() => setIsSavedBoardsModalOpen(true)}
        />
        {isSavedBoardsModalOpen && (
          <SavedWhiteboardsModal
            onClose={() => setIsSavedBoardsModalOpen(false)}
            onSelectBoard={(boardId) => {
              window.location.hash = `#room=${boardId}`;
