interface Window {
  ...
  // New Pomai Whiteboard globals
  POMAIWHITEBOARD_ASSET_PATH: string | string[] | undefined;
  POMAIWHITEBOARD_THROTTLE_RENDER: boolean | undefined;
  POMAIWHITEBOARD_EXPORT_SOURCE: string;
  // Legacy Excalidraw globals (kept for backward compatibility)
