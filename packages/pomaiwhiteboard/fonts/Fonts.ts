...
import { ExcalidrawFontFace } from "./PomaiFontFace";
...
import { PatrickHandSCFontFaces } from "./PatrickHandSC";
...
export class Fonts {
  ...
  private static init() {
    ...
    init("Excalifont", ...ArchitectsDaughterFontFaces);
    ...
    init("Patrick Hand SC", ...PatrickHandSCFontFaces);
    init("Virgil", ...ArchitectsDaughterFontFaces);
