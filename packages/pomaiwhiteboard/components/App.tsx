...
ExcalidrawContainerContext.displayName = "PomaiWhiteboardContainerContext";

const ExcalidrawElementsContext = React.createContext<
  readonly NonDeletedExcalidrawElement[]
>([]);
ExcalidrawElementsContext.displayName = "PomaiWhiteboardElementsContext";
...
ExcalidrawAppStateContext.displayName = "PomaiWhiteboardAppStateContext";
...
ExcalidrawSetAppStateContext.displayName = "PomaiWhiteboardSetAppStateContext";

const ExcalidrawActionManagerContext = React.createContext<ActionManager>(
  null!,
);
ExcalidrawActionManagerContext.displayName = "PomaiWhiteboardActionManagerContext";

export const ExcalidrawAPIContext =
  React.createContext<ExcalidrawImperativeAPI | null>(null);
ExcalidrawAPIContext.displayName = "PomaiWhiteboardAPIContext";

export const ExcalidrawAPISetContext = React.createContext<
  ((api: ExcalidrawImperativeAPI | null) => void) | null
>(null);
ExcalidrawAPISetContext.displayName = "PomaiWhiteboardAPISetContext";
...
let isRightClickPan: boolean = false;
let rightClickPanMoved: boolean = false;
...
class App extends React.Component<AppProps, AppState> {
      ...
      <>
        {embeddableElements.map((el) => {
          ...
          return (
            <div
              key={el.id}
              className={clsx("pomaiwhiteboard__embeddable-container", {
            ...
            >
              <div
                ...
                className="pomaiwhiteboard__embeddable-container__inner"
                style={{
              ...
              >
                {isHovered && (
                  <div className="pomaiwhiteboard__embeddable-hint">
                ...
                >
                  <div
                    className="pomaiwhiteboard__embeddable__content"
                    style={{
                    ...
                    {(isEmbeddableElement(el)
                      ...
                      : null) ?? (
                        <iframe
                          ...
                          title="Pomai Whiteboard Embedded Content"
  ...
  public render() {
    ...
    return (
      <div
        translate="no"
        className={clsx(
          "excalidraw pomaiwhiteboard excalidraw-container pomaiwhiteboard-container notranslate",
          this.props.className,
          {
            "excalidraw--view-mode pomaiwhiteboard--view-mode":
              this.state.viewModeEnabled ||
              this.state.openDialog?.name === "elementLinkSelector",
            "excalidraw--mobile pomaiwhiteboard--mobile": this.editorInterface.formFactor === "phone",
            "excalidraw--non-interactive pomaiwhiteboard--non-interactive": !this.isInteractionEnabled(),
            "excalidraw--navigation pomaiwhiteboard--navigation":
              !this.isInteractionEnabled() && this.isNavigationEnabled(),
            "excalidraw--tools pomaiwhiteboard--tools":
              !this.isInteractionEnabled() &&
              this.isToolSupported(this.state.activeTool.type),
            "excalidraw--embeds pomaiwhiteboard--embeds":
              !this.isInteractionEnabled() && this.isEmbedsEnabled(),
            "excalidraw--allow-browser-zoom pomaiwhiteboard--allow-browser-zoom":
              !this.isInteractionEnabled() && this.isBrowserZoomEnabled(),
            "excalidraw--ui-hidden pomaiwhiteboard--ui-hidden": !this.isDefaultUIEnabled(),
            "excalidraw--mobile-toolbar pomaiwhiteboard--mobile-toolbar":
              this.editorInterface.formFactor === "phone" &&
              this.isDefaultUIEnabled() &&
              !this.state.viewModeEnabled,
            "excalidraw--viewport-status-border pomaiwhiteboard--viewport-status-border":
              !!this.props.viewportStatusFrame?.border,
            "excalidraw--viewport-status-label pomaiwhiteboard--viewport-status-label":
              !!this.props.viewportStatusFrame?.label,
            "excalidraw--zen-mode pomaiwhiteboard--zen-mode": this.state.zenModeEnabled,
          },
        )}
        style={{
                    ...
                    <ExcalidrawAppStateContext.Provider value={this.state}>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="pomaiwhiteboard-textEditorContainer" />
                          <div className="pomaiwhiteboard-contextMenuContainer" />
                          <div className="pomaiwhiteboard-eye-dropper-container" />
                          <SVGLayer
                            trails={[
                              this.laserTrails,
                              this.lassoTrail,
  ...
  private createGenericElementOnPointerDown = (
    ...
    if (this.state.activeTool.type === "custom") {
      const customType = this.state.activeTool.customType;
      if (customType === "red-pin") {
        element = newElement({
          ...
          customData: { customType: "red-pin" },
        });
      } else if (customType === "evidence-card") {
        element = newElement({
          type: "rectangle",
          ...baseElementAttributes,
          width: 220,
          ...
          customData: { customType: "evidence-card" },
        });
      } else if (customType === "red-string") {
        element = newLinearElement({
          ...
          strokeWidth: 3,
          roughness: 2,
          customData: { customType: "red-string" },
        });
      } else {
        element = newElement({
          type: elementType === "embeddable" ? "rectangle" : elementType,
          ...baseElementAttributes,
          customData: { customType },
        });
      }
    } else if (elementType === "embeddable") {
  ...
  loadFileToCanvas = async (
    ...
    try {
      ...
      if (
        ret.type === MIME_TYPES.pomaiwhiteboard ||
        ...
        ret.type === MIME_TYPES.pomaiwhiteboardlib ||
        ret.type === MIME_TYPES.excalidrawlib ||
        ret.type === MIME_TYPES.pomailib
      ) {
        await this.library
          .updateLibrary({
            libraryItems: file,
