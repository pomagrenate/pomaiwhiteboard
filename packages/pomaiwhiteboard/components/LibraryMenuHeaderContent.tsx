...
export const useLibraryActions = (selectedItems: LibraryItem["id"][] = []) => {
    ...
    try {
      await library.updateLibrary({
        libraryItems: fileOpen({
          description:
            "Pomai Whiteboard library files (.pomaiwhiteboardlib, .excalidrawlib, .pomailib)",
          extensions: ["pomaiwhiteboardlib", "excalidrawlib", "pomailib"],
        }),
        merge: true,
  ...
  return { onLibraryImport, onLibraryExport };
};
...
export const LibraryDropdownMenuButton: React.FC<{
  ...
  const { onLibraryImport, onLibraryExport } = useLibraryActions(selectedItems);
